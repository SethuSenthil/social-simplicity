...
Disc.onMessage([{
  ...
  exe: (msg, args, params)=>{
    ...
    .setURL('https://social-simplicity-21.herokuapp.com/login?'+msg.author.id)
    .setDescription('Welcome to social simplicity! Some other BS here. Click [here](https://social-simplicity-21.herokuapp.com/login?'+msg.author.id+') to get started.')
